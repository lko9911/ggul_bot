...
public:
    ...
    {
        // 로봇 모델 로더 초기화
        auto node = this->shared_from_this();  // this->shared_from_this()로 명확히 호출

        robot_model_loader_ = std::make_shared<robot_model_loader::RobotModelLoader>(node, "robot_description");
